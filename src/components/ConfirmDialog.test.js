...
describe("ConfirmDialog", () => {
  ...
  describe("Content Variations", () => {
    it("should handle long messages", () => {
      const longMessage =
        "This is a very long message that should wrap properly and not break the dialog layout. It contains multiple sentences to test how the dialog handles longer content.";
    ...
    it("should handle special characters in title and message", () => {
      ...
      const specialMessage =
        "This will permanently delete the game & all data!";
